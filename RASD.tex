	...
	\subsection{Functional requirements}
		\begin{enumerate}
			...
			\item \textbf{View or modify the profile.}
				The passenger can see or edit his profile. He can modify or add his profile picture, other personal information and the credit card data. He can also update his personal information.
			\item \textbf{See waiting time panel.}
				The user can see the waiting time panel from the time he makes the request of a taxi until it arrives. This consists in a display showing the time the user has to wait till the taxi arrival.
