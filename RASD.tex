...
\newpage
	...
	\begin{itemize}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[scale=0.71]{SequenceSignup.jpg}
		\end{figure}
		\newpage
		\item User Log In
		\\ \\ \\
		\begin{center}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.6]{UseCaseLogin.jpg}
			\end{figure}
		\end{center}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[scale=0.75]{SequenceLogin.jpg}
		\end{figure}
			\newpage
			...
			\begin{center}
				...
				\begin{figure}[h]
					\centering
					\includegraphics[scale=0.8]{UseCaseProfile.jpg}
				\end{figure}
			\end{center}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.97]{SequenceProfile.jpg}
			\end{figure}
			\newpage
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.9]{SequenceRequest.jpg}
			\end{figure}
				\newpage
				...
				\begin{figure}[h]
					\centering
					\includegraphics[scale=0.8]{SequenceReserve.jpg}
				\end{figure}
				\newpage
				\item Taxi Area
				\\ \\ \\
				\begin{center}
					...
					\begin{figure}[h]
						\centering
						\includegraphics[scale=0.7]{UseCaseTaxiArea.jpg}
					\end{figure}
				\end{center}
